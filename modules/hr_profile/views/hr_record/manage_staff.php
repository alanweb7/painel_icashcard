...
if (isset($_GET['debug']) && $_GET['debug'] !== '') {
	echo "manage_staff.php view, table_staff.php view";
}
?>
<div id="wrapper">
	<div class="content">
					...
					<div class="panel-body">
						<div class="_buttons">
							<?php if (is_admin() || has_permission('hrm_hr_records', '', 'create') || has_permission('hrm_hr_records', '', 'edit')) { ?>
								...
								<!-- <a href="<?php //echo admin_url('hr_profile/new_member'); 
												?>" class="btn mright5 btn-info pull-left display-block "><?php //echo _l('new_staff'); 
																											?></a> -->
						...
						<div class="row">
							...
							<div class="col-md-3 leads-filter-column pull-right">
								<select name="hr_profile_fantasy_name" class="selectpicker" id="hr_profile_fantasy_name" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo 'Gerente'; ?>">
									<option value=""></option>
									<?php
									foreach ($gerentes as $value) { ?>
										<option value="<?php echo html_entity_decode($value['staffid']); ?>"><?php echo html_entity_decode($value['nome_fantasia']) ?></option>
									<?php }
									?>
								</select>
							</div>
							...
							<div class="col-md-3 pull-right">
								<input type="text" id="staff_cnpj" name="staff_cnpj" class="form-control" placeholder="CNPJ" autocomplete="off">
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<?php if (staff_can('delete', 'user_manager') || is_admin()) { ?>
								...
								if (staff_can('delete', 'user_manager') || is_admin()) {
									$nation = '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="table_staff"><label></label></div>';
								};
