    ...
    <div class="row">
      <div class="panel_s">
        <div class="panel-body">
          ...
          <hr />
          <?php if($is_client == 1){ ?>
            <a href="<?php echo admin_url('commission/new_applicable_client'); ?>" class="btn btn-info mbot10"><?php echo 'Novo Plano'; ?></a>
          <?php }else{ ?>
            <a href="<?php echo admin_url('commission/new_applicable_staff'); ?>" class="btn btn-info mbot10"><?php echo 'Novo Plano'; ?></a>
          <?php } ?>
          <div class="row">
            <div class="col-md-3">
