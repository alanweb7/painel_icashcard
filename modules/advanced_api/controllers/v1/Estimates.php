...
class Estimates extends RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/estimates List All Estimates
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/estimates
     *
    ...
    /**
     * @api {get} /advanced_api/v1/estimates/id/:id Request Estimates By ID
     *
     * @apiVersion 1.0.0
     *
    ...
    public function estimates_get()
    {
        ...
        $estimateData = $this->advanced_api_model->getTable('estimates', $estimateID, $this->clientInfo['data']);
