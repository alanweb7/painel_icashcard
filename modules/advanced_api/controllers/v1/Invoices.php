...
class Invoices extends RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/invoices List All Invoices
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/invoices
     *
    ...
    /**
     * @api {get} /advanced_api/v1/invoices/id/:id Request Invoice By ID
     *
     * @apiVersion 1.0.0
     *
    ...
    public function invoices_get()
    {
        ...
        $invoiceData = $this->advanced_api_model->getTable('invoices', $invoiceID, $this->clientInfo['data']);
