...
class Proposals extends RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/proposals List All Proposals
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/proposals
     *
    ...
    /**
     * @api {get} /advanced_api/v1/proposals/id/:id Request Proposal By ID
     *
     * @apiVersion 1.0.0
     *
    ...
    public function proposals_get()
    {
        ...
        $proposalData = $this->advanced_api_model->getTable('proposals', $proposalID, $this->clientInfo['data']);
    ...
    /**
     * @api {post} /advanced_api/v1/proposals/id/:id/group/proposals_comment Add Proposal Comments
     *
     * @apiVersion 1.0.0
     *
    ...
    public function proposals_post()
    {
        ...
        if (!empty($parameters['group']) && !empty($parameters['id'])) {
            $data = $this->advanced_api_model->addComments($postData, $parameters, $this->clientInfo['data']);
