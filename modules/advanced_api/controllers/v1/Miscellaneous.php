...
class Miscellaneous extends RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/miscellaneous/group/client_menu Get client menu
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/miscellaneous/group/client_menu
     *
    ...
    /**
     * @api {get} /advanced_api/v1/miscellaneous/group/departments List all departments
     *
     * @apiVersion 1.0.0
     *
     ...
     * @apiHeader {String} Authorization <span class="btn btn-xs btn-danger">Required</span> Basic Access Authentication token.
     *
     * @apiSampleRequest /advanced_api/v1/miscellaneous/group/departments
     *
     * @apiSuccess {Boolean} status  Response status.
    ...
    /**
     * @api {get} /advanced_api/v1/miscellaneous/group/get_ticket_priorities List ticket priorities
     *
     * @apiVersion 1.0.0
     *
     ...
     * @apiHeader {String} Authorization <span class="btn btn-xs btn-danger">Required</span> Basic Access Authentication token.
     *
     * @apiSampleRequest /advanced_api/v1/miscellaneous/group/get_ticket_priorities
     *
     * @apiSuccess {Boolean} status  Response status.
    ...
    /**
     * @api {get} /advanced_api/v1/miscellaneous/group/get_services List all services
     *
     * @apiVersion 1.0.0
     *
     ...
     * @apiHeader {String} Authorization <span class="btn btn-xs btn-danger">Required</span> Basic Access Authentication token.
     *
     * @apiSampleRequest /advanced_api/v1/miscellaneous/group/get_services
     *
     * @apiSuccess {Boolean} status  Response status.
    ...
    public function Miscellaneous_get()
    {
        ...
        if (!empty($group)) {
            $data = $this->advanced_api_model->getMiscellaneousGroups($group, $this->clientInfo['data']);
