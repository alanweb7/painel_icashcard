...
class Projects extends \AdvancedApi\RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/projects/id/:id Request Project By ID
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/projects/
     *
    ...
    /**
     * @api {get} /advanced_api/v1/projects List All Projects
     *
     * @apiVersion 1.0.0
     *
    ...
    /**
     * @api {get} /advanced_api/v1/projects/id/:id/group/:groupname Request Project Groups Information
     *
     * @apiVersion 1.0.0
     *
    ...
    public function projects_get()
    {
        ...
        $projectData = $this->advanced_api_model->getTable('projects', $projectID, $this->clientInfo['data']);
        ...
        if (!empty($group) && !empty($projectID)) {
            $projectData = $this->advanced_api_model->getProjectGroups($projectID, $group, $this->clientInfo['data']);
    ...
    /**
     * @api {post} /advanced_api/v1/projects/id/:id/group/tasks Add task to a project
     *
    ...
    public function projects_post()
    {
        ...
        if (!empty($group)) {
            switch ($group) {
                case 'tasks':
                    $data = $this->advanced_api_model->addTask($projectID, $postData, $this->clientInfo['data']);
    ...
    /**
     * @api {put} /advanced_api/v1/projects/id/:id/group/tasks Update task
     *
     * @apiName UpdateTask
     *
     * @apiGroup Task
    ...
    public function projects_put()
    {
        ...
        if (!empty($group)) {
            switch ($group) {
                case 'tasks':
                    $data = $this->advanced_api_model->updateTask($projectID, $updateData, $this->clientInfo['data']);
                    $this->response($data['response'], $data['response_code']);
                    break;
