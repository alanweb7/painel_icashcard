...
class Contracts extends RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/contracts List All Contracts
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/contracts
     *
    ...
    /**
     * @api {get} /advanced_api/v1/contracts/id/:id Request Contract By ID
     *
     * @apiVersion 1.0.0
     *
    ...
    public function contracts_get()
    {
        ...
        $contractData = $this->advanced_api_model->getTable('contracts', $contractID, $this->clientInfo['data']);
    ...
    /**
     * @api {post} /advanced_api/v1/contracts/id/:id/group/contract_comment Add Contract Comments
     *
     * @apiVersion 1.0.0
     *
