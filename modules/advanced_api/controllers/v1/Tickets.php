...
class Tickets extends \AdvancedApi\RestController
{
    ...
    /**
     * @api {get} /advanced_api/v1/tickets List All Tickets
     *
     * @apiVersion 1.0.0
     *
     ...
     *
     * @apiSampleRequest /advanced_api/v1/tickets
     *
    ...
    /**
     * @api {get} /advanced_api/v1/tickets/id/:id Request Tickets By ID
     *
     * @apiVersion 1.0.0
     *
    ...
    public function tickets_get()
    {
        ...
        $ticketData = $this->advanced_api_model->getTable('tickets', $ticketsID, $this->clientInfo['data']);
        $this->response($ticketData['response'], $ticketData['response_code']);
    }

    /**
     * @api {post} /advanced_api/v1/tickets Add New Ticket
     *
    ...
    /**
     * @api {post} /advanced_api/v1/tickets/add_reply/:id Add New Reply To A Ticket
     *
    ...
    public function tickets_post()
    {
        ...
        $postData = $this->post();
        if (empty($ticketID)) {
            $data = $this->advanced_api_model->addTicket($postData, $this->clientInfo['data']);
        }

        if (!empty($ticketID)) {
            $data = $this->advanced_api_model->addReplyToATicket($postData, $this->clientInfo['data'], $ticketID);
        }
