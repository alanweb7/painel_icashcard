...
use Firebase\JWT\JWT as  Advanced_Rest_JWT;
use Firebase\JWT\Key as  Advanced_Rest_Key;
...
class Authorization_token
{
    ...
    public function generateToken($data = null)
    {
        if ($data && is_array($data)) {
            try {
                return  Advanced_Rest_JWT::encode($data, base_url(), $this->token_algorithm);
            } catch (Exception $e) {
    ...
    public function validateToken()
    {
        ...
        if (true === $token_data['status']) {
            try {
                 ...
                 */
                try {
                    $token_decode =  Advanced_Rest_JWT::decode($token_data['token'], new  Advanced_Rest_Key(base_url(), $this->token_algorithm));
                } catch (Exception $e) {
