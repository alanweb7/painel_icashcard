...
function DecodeJWTtoken(string $encodedToken, string $jwt_secret_key)
{
    // new logic added
    try {
        $decodedToken =  Advanced_Rest_JWT::decode($encodedToken, new  Advanced_Rest_Key($jwt_secret_key, 'HS512'));
...
function EncodeJWTtoken(array $data, string $jwt_secret_key)
{
    ...
    $encodedToken =  Advanced_Rest_JWT::encode($payload, $jwt_secret_key, 'HS512');
