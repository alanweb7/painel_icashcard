    ...
    public function get_info()
    {
        ...
        if( $this->input->is_ajax_request() && !empty( $page_url ) && !empty( $table_class ) )
        {
            ...
            if( !is_admin() && !empty( $staff_role_info->role ) )
            {
                ...
                $setting_roles = $this->db->select('id,hiddens')
            ...
            if( !empty( $hidden_columns ) )
            {
                ...
                echo json_encode( [ 'headers' => $hidden_columns , 'has_record' => $has_record] );
        ...
        echo json_encode( [ 'headers' => null , 'has_record' => $has_record ] );
    ...
    public function get_role_info()
    {
        ...
        if( $this->input->is_ajax_request() && !empty( $page_url ) && !empty( $table_class ) && !empty( $role_id ) )
        {
            ...
            if( !empty( $setting ) )
            {
                ...
                echo json_encode( [ 'headers' => json_decode( $setting->hiddens , 1 ) ] );
